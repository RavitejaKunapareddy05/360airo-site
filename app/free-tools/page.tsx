      ...
      <section className="py-12 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-white/2 via-[#19001d]/30 to-white/2">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            {/* 3x3 Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 mb-8">
              ...
              >
                ...
                <Link href={freeTools[9].href}>
                  <div className="relative bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-4 lg:p-6 border border-white/10 group-hover:border-purple-500/30 transition-all duration-500 h-full cursor-pointer">
                    <motion.div
                      className={`bg-gradient-to-r ${freeTools[9].color} w-12 h-12 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center mb-4 lg:mb-6 mx-auto`}
                      whileHover={{ rotate: [0, -15, 15, 0], scale: 1.15 }}
                      transition={{ duration: 0.5 }}
                    >
                      {(() => {
                        const Icon = freeTools[9].icon;
                        return <Icon className="h-6 w-6 lg:h-8 lg:w-8 text-white" />;
                      })()}
                    </motion.div>
                    <h4 className="text-lg lg:text-xl font-bold text-white mb-3 lg:mb-4 group-hover:text-indigo-300 transition-colors text-center">{freeTools[9].name}</h4>
                    <p className="text-white/70 leading-relaxed text-sm lg:text-base text-center">{freeTools[9].description}</p>
                    <div className="flex items-center justify-center gap-2 text-purple-400 group-hover:text-indigo-300 transition-colors mt-4 text-sm font-medium">
                      <span>Access Tool</span>
                      <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </div>
                  </div>
