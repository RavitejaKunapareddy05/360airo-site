    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0014] via-[#19001d] to-[#0a0014] overflow-hidden">
              ...
              <div className="space-y-6 lg:space-y-8 order-1">
                ...
                >
                  <p className="text-base sm:text-lg text-white/85 leading-relaxed font-light">
                    360Airo helps teams plan, send, and track outreach across email, LinkedIn, and calls from one workspace.
                  </p>
        ...
        <section className="py-10 lg:py-14 px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={containerVariants} className="max-w-4xl mx-auto">
            <motion.div variants={itemVariants} className="text-center mb-8 lg:mb-10">
              <div className="inline-block mb-2">
                <span className="text-[#b45ecf] font-semibold text-sm tracking-wider uppercase">Google Data Usage</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">
              ...
              <SectionDivider />
              <p className="text-base lg:text-lg text-white/80 max-w-3xl mx-auto">
                If you connect Gmail, 360Airo uses Google data only to send and manage the outreach emails you choose to send.
              </p>
            </motion.div>

            <div className="space-y-3 text-white/80 text-sm lg:text-base max-w-3xl mx-auto">
              <p>
                Gmail usage: send emails from your connected Gmail account and record delivery and reply status inside 360Airo.
              </p>
              <p>
                Email sending purpose: deliver your outreach emails to the recipients you select and schedule.
              </p>
            </div>
          </motion.div>
        </section>
