...
export default function EmailVerificationBlog() {
  ...
  const handleLike = () => {
    setLiked(!liked);
    toast({
      title: liked ? "Article unliked" : "Article liked!",
      description: liked ? "Thanks for your feedback" : "Glad you found this helpful!",
    });
  };
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: bookmarked ? "Article removed from saved" : "Article saved for later",
    });
  };
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      ...
      toast({
        title: "Link copied!",
        description: "Share this article with your team",
      });
    }
  };
