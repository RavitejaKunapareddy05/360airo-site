  ...
  const features = [
    {
      ...
      features: [
        ...
        "Sync effortlessly with <a href="/features/ai-email-automation" className="text-[#b45ecf] hover:text-white transition-colors">AI Email Automation" </a>
      ],
    ...
    },
    {
      ...
      features: [
        "Create email copy instantly via <a href="/features/ai-email-generator" className="text-[#b45ecf] hover:text-white transition-colors"> AI Email Generator" </a> ,
