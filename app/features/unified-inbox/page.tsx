  ...
  const featureSections = [
    ...
    },
    {
      ...
      features: [
        ...
        "Maintain full visibility over all prospect interactions through <a href='/features/prospect-crm' class='text-[#b45ecf] font-semibold hover:text-white transition-colors duration-300 underline underline-offset-2'>Prospect CRM</a>",
    ...
    },
    {
      ...
      features: [
        ...
        "Manage all team communication using our <a href='/features/team-collaboration' class='text-[#b45ecf] font-semibold hover:text-white transition-colors duration-300 underline underline-offset-2'>Team Collaboration</a> tools"
      ],
      ...
      <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/30 to-blue-950/50 overflow-hidden">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-16 lg:pt-20 overflow-hidden">
          ...
          >
            ...
            >
              Your entire team can view, respond, and manage conversations in real time — without overlapping replies, missed messages, or confusion. Team Collaboration becomes seamless and organized.
            </motion.p>
