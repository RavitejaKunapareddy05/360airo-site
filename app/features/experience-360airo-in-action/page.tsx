...
export default function DemoPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-screen py-20">
            ...
            >
              <motion.div
                ...
                className="bg-[#1A1A1A] rounded-3xl p-8 border-2 shadow-2xl"
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-white text-sm font-medium">360Airo Dashboard</div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <motion.div
                      ...
                      className="col-span-2 h-24 rounded-xl"
      ...
      <PulsingSection className="py-20 px-6 bg-[#0A0A0A]">
          ...
          >
            ...
            >
              ...
              >
                <Button 
                  size="lg" 
                  className="px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl border-0 relative overflow-hidden group"
                  style={{ background: COLORS.purpleLight }}
                >
                  <motion.span
                    animate={{
