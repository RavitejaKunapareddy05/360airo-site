...
const TargetAudience = () => {
  const audiences = [
    ...
    },
    {
      ...
      description: (
        <a 
          href="https://360airo.com/features/360airo-affiliate-program" 
          style={{ 
            textDecoration: 'none', 
            color: 'inherit',
            cursor: 'pointer' 
        ...
        >
          Agencies can also generate additional revenue by joining the 360Airo Affiliate Program.
        </a>
      ),
      color: COLORS.purpleDarker
    },
...
const DemoBenefits = () => {
  const benefits = [
    {
      id: "live-walkthrough",
      content: "Live, interactive walkthrough — not just a video"
    },
    {
      id: "referral-program",
      content: (
        <span>
          Personalized session tailored to your team's goals. Teams that love the platform can also earn rewards through the{" "}
          <a 
    ...
    {
      id: "real-time-qa",
      content: "Real-time Q&A with our product experts"
    },
    {
      id: "hands-on-experience",
      content: "Hands-on experience with AI-driven tools and dashboards"
    },
    {
      id: "free-trial",
