  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-[#b45ecf] to-[#480056] rounded-full opacity-10 blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, -80, 0],
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="text-white/90 font-semibold">AI Sales Development Representative</span>
          </motion.div>
          ...
          >
            ...
            <motion.span
              ...
              className="block text-2xl md:text-3xl lg:text-4xl font-light mt-4 text-white/80"
            >
              Powered by 360Airo
            </motion.span>
          </motion.h1>
          ...
          >
            ...
            >
              <Button 
                size="lg" 
                className="bg-white text-black hover:bg-white/90 hover:shadow-2xl hover:shadow-purple-500/25 text-lg px-8 py-6 rounded-full font-semibold shadow-lg transition-all duration-300 group relative overflow-hidden"
              >
                <motion.div
                ...
                />
                <Rocket className="mr-3 h-5 w-5 group-hover:scale-110 transition-transform" />
                Book Demo
            ...
            >
              <Button 
                variant="outline"
                size="lg" 
                className="border-white text-white hover:bg-white/10 hover:border-white/30 text-lg px-8 py-6 rounded-full font-semibold backdrop-blur-sm transition-all duration-300 group"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="p-6 rounded-2xl bg-red-500/10 border border-red-500/20 backdrop-blur-sm hover:border-red-500/30 transition-all duration-300"
              >
              ...
              <motion.div
                ...
                className="p-6 rounded-2xl bg-green-500/10 border border-green-500/20 backdrop-blur-sm hover:border-green-500/30 transition-all duration-300"
              >
            ...
            >
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
                className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500"
              >
                <div className="grid grid-cols-2 gap-4">
                  {metrics.map((metric, index) => (
                    <motion.div
                      ...
                      className="bg-white/5 rounded-2xl p-6 text-center backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer"
                    >
                      <motion.div
                        animate={{ rotate: [0, 10, 0] }}
                        transition={{ duration: 2, repeat: Infinity, delay: index * 0.5 }}
                      >
                        <metric.icon className="w-8 h-8 text-white mb-3 mx-auto" />
                      </motion.div>
          ...
          <div className="space-y-8">
            {workflowSteps.map((step, index) => (
              <motion.div
                ...
                className={`flex flex-col lg:flex-row items-center gap-8 p-8 rounded-3xl bg-gradient-to-r from-gray-900/50 to-black hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-500 group ${
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-6">
                    <motion.div
                      ...
                      className={`w-16 h-16 bg-gradient-to-br ${step.gradient} rounded-2xl flex items-center justify-center text-white text-xl font-bold shadow-lg group-hover:shadow-xl transition-all duration-300 relative overflow-hidden`}
                    >
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent"
                        animate={{
                    ...
                    >
                      <step.icon className={`w-8 h-8 text-transparent bg-gradient-to-br ${step.gradient} bg-clip-text`} />
                    </motion.div>
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-300 group-hover:bg-clip-text">
                    {step.title}
                  </h3>
                ...
                <div className="flex-1">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    className={`bg-gradient-to-br ${step.gradient} rounded-3xl p-8 h-64 flex items-center justify-center relative overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500`}
                  >
                    <motion.div
                    ...
                    <div className="text-white text-center relative z-10">
                      ...
                      <h4 className="text-xl font-semibold bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 inline-block">
                        {step.title.split(' ')[0]}
                      </h4>
                    </div>
                  </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {keyFeatures.map((feature, index) => (
              <motion.div
                ...
                className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:bg-gray-800/50 hover:border-purple-500/30 transition-all duration-500 group relative overflow-hidden"
              >
                <motion.div 
                  className={`absolute -inset-1 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500 rounded-2xl`}
                  animate={{
                    rotate: [0, 5, 0],
                  }}
                  transition={{
                ...
                <div className="relative z-10">
                  <motion.div 
                    className={`w-14 h-14 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg relative overflow-hidden`}
                    whileHover={{
                      scale: 1.1,
                      rotate: 12
                    }}
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-purple-200 group-hover:bg-clip-text">
                    {feature.title}
                  </h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 text-center hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-500 group border border-gray-800 relative overflow-hidden"
              >
                <motion.div
                ...
                />
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center text-white mb-6 mx-auto group-hover:scale-110 transition-transform duration-300 relative z-10">
                  <motion.div
                    animate={{ rotate: [0, 360] }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  >
                ...
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text relative z-10">
                  {benefit.title}
                </h3>
                <p className="text-gray-300 leading-relaxed relative z-10 group-hover:text-white">
                  {benefit.description}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-20 bg-gradient-to-br from-[#480056] to-[#b45ecf] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ duration: 0.8, type: "spring" }}
            className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20 hover:border-white/30 transition-all duration-500"
          >
            <motion.div
              animate={{ 
                scale: [1, 1.05, 1],
              ...
              className="w-20 h-20 bg-gradient-to-br from-white to-purple-200 rounded-2xl flex items-center justify-center text-black mb-8 mx-auto"
            >
            ...
            >
              ...
              >
                ...
                />
                <Rocket className="mr-3 h-5 w-5 group-hover:scale-110 transition-transform relative z-10" />
