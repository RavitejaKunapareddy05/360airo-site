      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="text-white/90 font-semibold">360Airo Case Studies</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[#480056]/20 border border-[#480056]/30 backdrop-blur-sm hover:border-[#b45ecf]/30 transition-all duration-300"
              >
              ...
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[#b45ecf]/10 border border-[#b45ecf]/20 backdrop-blur-sm hover:border-[#b45ecf]/30 transition-all duration-300"
              >
            ...
            >
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
                className="bg-gradient-to-br from-[#b45ecf]/20 to-[#480056]/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500"
              >
                <div className="text-center mb-8">
                  ...
                  <h4 className="text-2xl font-bold text-white">Here are some of the stories that show how 360Airo helps businesses achieve more with less effort.</h4>
                </div>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="space-y-32">
            {caseStudies.map((study, index) => (
              <motion.div
                ...
                className={`relative ${index % 2 === 0 ? 'lg:pr-20' : 'lg:pl-20'}`}
              >
                {/* Background Accent */}
                <motion.div
                  className={`absolute inset-0 bg-gradient-to-br ${study.gradient} opacity-5 rounded-3xl -z-10`}
                  whileInView={{ scale: 1 }}
                  initial={{ scale: 0.8 }}
                ...
                <div className={`flex flex-col lg:flex-row gap-12 items-center ${
                    ...
                    >
                      ...
                      <div className="flex items-center gap-6">
                        <motion.div
                          ...
                          className={`w-20 h-20 bg-gradient-to-br ${study.gradient} rounded-3xl flex items-center justify-center text-white text-2xl font-bold shadow-2xl transition-all duration-300`}
                        >
                          {study.id}
                        </motion.div>
                        <div>
                      ...
                      <div className="space-y-6">
                        <motion.div
                          ...
                          className="p-6 rounded-2xl bg-[#480056]/20 border border-[#480056]/30 backdrop-blur-sm"
                        >
                          <h4 className="font-semibold text-[#b45ecf] mb-3 text-lg">Challenge</h4>
                          <p className="text-gray-300 leading-relaxed">{study.challenge}</p>
                        </motion.div>
                        <motion.div
                          whileHover={{ scale: 1.02, y: -5 }}
                          className="p-6 rounded-2xl bg-[#b45ecf]/10 border border-[#b45ecf]/20 backdrop-blur-sm"
                        >
                          <h4 className="font-semibold text-white mb-3 text-lg">Solution</h4>
                          <p className="text-gray-300 leading-relaxed">{study.solution}</p>
                        </motion.div>
                        <motion.div
                          whileHover={{ scale: 1.02, y: -5 }}
                          className="p-6 rounded-2xl bg-[#480056]/10 border border-[#480056]/20 backdrop-blur-sm"
                        >
                          <h4 className="font-semibold text-[#b45ecf] mb-3 text-lg">Results</h4>
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        {study.metrics.map((result, resultIndex) => (
                          <motion.div
                            ...
                            className="text-center p-4 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#b45ecf]/30 transition-all duration-300"
                          >
                            <div className="text-2xl md:text-3xl font-bold text-white mb-2">{result.metric}</div>
                      ...
                      <motion.div
                        ...
                        className="p-6 rounded-2xl bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm border border-white/10"
                      >
                        <Quote className="w-8 h-8 text-[#b45ecf] mb-4" />
                        <p className="text-gray-300 italic text-lg leading-relaxed">"{study.quote}"</p>
                      </motion.div>
                    </motion.div>
                  </div>
                  ...
                  <div className="flex-1">
                    <motion.div
                      ...
                      className={`bg-gradient-to-br ${study.gradient} rounded-4xl p-12 h-96 flex items-center justify-center relative overflow-hidden shadow-2xl group`}
                    >
                      ...
                      <div className="text-white text-center relative z-10">
                        ...
                        <h4 className="text-2xl font-semibold mb-4 bg-white/20 backdrop-blur-sm rounded-full px-8 py-3 inline-block">
                          Case Study {study.id}
                        </h4>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keyInsights.map((insight, index) => (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-[#b45ecf]/30 transition-all duration-500 group relative overflow-hidden"
              >
                <motion.div
                  className={`absolute inset-0 bg-gradient-to-br ${insight.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-3xl`}
                  animate={{
                    rotate: [0, 5, 0],
                  }}
                  transition={{
                ...
                />
                <motion.div
                  className={`w-16 h-16 bg-gradient-to-br ${insight.gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg relative overflow-hidden`}
                  whileHover={{
                    scale: 1.1,
                    rotate: 12
                  }}
                >
                  ...
                  />
                  <insight.icon className="w-8 h-8 relative z-10" />
                </motion.div>
                <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-[#b45ecf] group-hover:bg-clip-text">
                  {insight.title}
                </h3>
