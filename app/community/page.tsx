...
<<<<<<< HEAD
  // Define SEO metadata
  const pageTitle = "Join the 360Airo Community | 10,000+ Sales & Marketing Professionals";
  const pageDescription = "Join 10,000+ sales and marketing professionals in the 360Airo community. Access expert sessions, exclusive templates, networking events, and AI outreach strategies — free forever.";
  const canonicalUrl = "https://360airo.com/community";
  const pageKeywords = "360Airo community, sales community, marketing community, outreach professionals, networking for sales, marketing automation community, AI outreach community, sales professionals network";
  const pageImage = "https://360airo.com/og-community.jpg";
  ...
  return (
    <>
      ...
      <div className="hidden">
        ...
        {/* JSON-LD Structured Data for Community */}
        <script
...
=======
  return (
      <>
          <Head>
        <title>Join the 360Airo Community | 10,000+ Sales & Marketing Professionals</title>
        <meta name="description" content="Join 10,000+ sales and marketing professionals in the 360Airo community. Access expert sessions, exclusive templates, networking events, and AI outreach strategies — free forever." />
      </Head>
